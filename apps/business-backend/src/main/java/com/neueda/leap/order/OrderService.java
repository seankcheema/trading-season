...
import com.neueda.leap.account.AccountNotFoundException;
import com.neueda.leap.account.AccountRepository;
import com.neueda.leap.instrument.Instrument;
import com.neueda.leap.instrument.InstrumentNotFoundException;
import com.neueda.leap.instrument.InstrumentRepository;
import com.neueda.leap.order.audit.AuditTrailService;
import com.neueda.leap.order.dto.OrderRequest;
import com.neueda.leap.order.execution.OrderExecutionService;
import com.neueda.leap.order.validation.OrderValidationPipeline;
...
public class OrderService {
    ...
    public Order submitOrder(OrderRequest request) {
        ...
        // TODO(KAN-95 follow-up): once identity resolution is wired up (see
