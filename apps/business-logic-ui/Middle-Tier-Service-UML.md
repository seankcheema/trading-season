...
│ - Creates LoginDto { username, password }                    │
│ - Makes HTTP POST request to /auth/login                     │
│ - Sends to NestJS auth service                               │
└──────────────────────────────────────────────────────────────┘
           ↓
┌──────────────────────────────────────────────────────────────┐
│ Step 6: Backend authenticates username + password            │
...
│ - Creates RegisterDto { username, password }                 │
...
│ - If duplicate username: return 409 Conflict                 │
